...
var range=normalizeScanRange(getStoredScanRange(player));
...
factions.sort();
return {npcs:npcs,factions:factions,scanRange:range,overlayEntities:overlayEntities};
}
...
var File=Java.type("java.io.File"),roots=[new File("customnpcs/dc_admins"),new File("./customnpcs/dc_admins"),new File(".minecraft/customnpcs/dc_admins"),new File("./.minecraft/customnpcs/dc_admins")],i,dir;
for(i=0;i<roots.length;i++){
dir=roots[i];
try{if(dir.exists()||dir.mkdirs())return dir;}catch(err){}
}
return null;
}
...
var File=Java.type("java.io.File"),out=[],seen={},baseCandidates=[new File("customnpcs/scripts/ecmascript"),new File("./customnpcs/scripts/ecmascript"),new File(".minecraft/customnpcs/scripts/ecmascript"),new File("./.minecraft/customnpcs/scripts/ecmascript")],i;
